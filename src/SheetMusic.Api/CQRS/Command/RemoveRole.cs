...
public class RemoveRole(Guid userId, string roleName) : IRequest
{
    public Guid UserId { get; } = userId;
    public string RoleName { get; } = roleName;

    public class Handler(UserManager<ApplicationUser> userManager) : IRequestHandler<RemoveRole>
    {
        public async Task Handle(RemoveRole request, CancellationToken cancellationToken)
        {
